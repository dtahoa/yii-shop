...
<div class="sub-page">
    ...
    <div class="sort">
        ...
        <select name="sort" id="goto">
            <option <?php if($sort == 'price asc') echo 'selected';?> value='<?php echo $this->createUrl("/shop/products/all"). "/price/asc/page/$currentPage";?>'>Price: Low to Height</option>
            <option <?php if($sort == 'price desc') echo 'selected';?> value='<?php echo $this->createUrl("/shop/products/all"). "/price/desc/page/$currentPage";?>'>Price: Height to Low</option>
            <option <?php if($sort == 'created_time desc') echo 'selected';?> value='<?php echo $this->createUrl("/shop/products/all"). "/date/desc/page/$currentPage";?>'>Date: New to Old</option>
            <option <?php if($sort == 'created_time asc') echo 'selected';?> value='<?php echo $this->createUrl("/shop/products/all"). "/date/asc/page/$currentPage";?>'>Date: Old to New</option>
        </select>
    </div>
