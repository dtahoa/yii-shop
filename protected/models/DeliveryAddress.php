...
/**
 * This is the model class for table "shop_delivery_address".
 *
 * The followings are the available columns in table 'shop_delivery_address':
 * @property integer $id
